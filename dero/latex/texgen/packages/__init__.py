from dero.latex.figure.packages import default_packages as default_figure_packages
from dero.latex.table.models.texgen.packages import default_packages as default_table_packages
